...
// If connection not put back in connection pool it will not close. But it will close when it put back.
...
// Put can put connection back in connection pool. If connection has been closed, the connection pool will be close too.

...
func InitHttp() {
	loginTemplate = template.Must(template.ParseFiles("./static/template/login.html"))
	profileTemplate = template.Must(template.ParseFiles("./static/template/profile.html"))
	resultTemplate = template.Must(template.ParseFiles("./static/template/result.html"))
